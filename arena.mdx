---
title: "Chatbot Arena"
description: "Chatbot Arena is an LLM benchmark platform featuring anonymous, randomized battles, available at https://chat.lmsys.org.
...
<Card title="Method 1" icon="1" iconType="duotone">
  This is how you use a card with an icon and a link. Clicking on this card
  brings you to the Card Group page.
</Card>
  1. Contribute the code to support this model in FastChat by submitting a pull request. See [instructions](model_support#how-to-support-a-new-model).
...
<Card title="Method 2" icon="2" iconType="duotone">
  Hosted by 3rd party API providers or yourself.
</Card>
  ...
  2. You can use FastChat's OpenAI API [server](openai_api) to serve your model with OpenAI-compatible APIs and provide us with the endpoint.
